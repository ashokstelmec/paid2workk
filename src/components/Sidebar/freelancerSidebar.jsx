...
const FreelancerSidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenu: [
        { title: "Explore", route: "/dashboard/projects/explore" },
        { title: "My Projects", route: "/dashboard/projects/my-projects" },
        {
          title: "Applied Projects",
          route: "/dashboard/projects/applied-projects",
        },
      ],
    },
    {
      title: "Saved",
      icon: <FaRegHeart className="w-4 h-4" />,
      hasDropdown: true,
      route: "/dashboard/saved/projects",
      subMenu: [
        { title: "Projects", route: "/dashboard/saved/projects" },
        { title: "Freelancers", route: "/dashboard/saved/freelancers" },
      ],
    },
    {
      title: "Payments",
    ...
    },
    {
      ...
      subMenu: [
        { title: "My Feedbacks", route: "/dashboard/feedbacks/my-feedbacks" },
        {
          ...
          route: "/dashboard/feedbacks/client-feedbacks",
        },
      ],
    },
  ];
  ...
  return (
    <div
      className={`bg-white fixed hidden md:flex flex-col h-[calc(100%-2.5rem)] px-2 rounded-xl border overflow-x-hidden overflow-y-auto z-40 top-1/2 -translate-y-1/2
                      ...
                      {item.subMenu.map((subItem, subIndex) => {
                        ...
                        return (
                          <NavLink
                            key={subIndex}
                            to={subItem.route}
                            className={`w-full flex items-center gap-2 px-3 py-1.5 mb-0.5 text-sm
                  ${
                    isSubActive
                      ? "text-blue bg-blue/5 hover:bg-blue/10"
                      : "text-black/70 hover:bg-black/5"
