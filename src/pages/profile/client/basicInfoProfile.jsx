...
const BasicInfo = () => {
  ...
  // Add state for storing selected IDs
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      ...
      try {
        ...
        data.append("companyName", formValues.companyTitle);
  ...
  return (
    <div className="space-y-4 px-5 pb-5">
      <div className="flex flex-col md:flex-row gap-8 items-start pt-10 md:px-10">
        ...
        <form
          className="md:pl-5 w-full md:w-2/3"
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* 🔹 Language */}
            <div>
              <FormControl fullWidth error={wasSubmitted && !!errors.language}>
